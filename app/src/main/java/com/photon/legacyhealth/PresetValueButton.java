...
public class PresetValueButton extends RelativeLayout implements RadioCheckable{
    ...
    private void parseAttributes(AttributeSet attrs) {
        ...
        try {
            ...
            mValueTextColor = a.getColor(R.styleable.PresetValueButton_presetButtonValueTextColor, resources.getColor(R.color.app_button_blue));
            mPressedTextColor = a.getColor(R.styleable.PresetValueButton_presetButtonPressedTextColor, resources.getColor(R.color.unpressed_btn));
        } finally {
            a.recycle();
        }
    }
